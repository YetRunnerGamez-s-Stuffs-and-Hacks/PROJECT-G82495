...
void render_hud_coins(void) {
    print_text(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(170), (HUD_TOP_Y - 17), "$"); // 'Coin' glyph
    print_text(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(186), (HUD_TOP_Y - 17), "*"); // 'X' glyph
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(200), (HUD_TOP_Y- 17), "%02d", gHudDisplay.coins);
}
...
void render_hud_stars(void) {
    print_text(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(170), (HUD_TOP_Y), "^"); // 'Coin' glyph
    print_text(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(186), (HUD_TOP_Y), "*"); // 'X' glyph
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(200), (HUD_TOP_Y), "%02d", gHudDisplay.stars);
}
/**
...
void render_hud_keys(void) {
    print_text(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(170), (HUD_TOP_Y - 34), "|"); // 'Coin' glyph
    print_text(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(186), (HUD_TOP_Y - 34), "*"); // 'X' glyph
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(200), (HUD_TOP_Y- 34), "%02d", gHudDisplay.keys);
}
/**
